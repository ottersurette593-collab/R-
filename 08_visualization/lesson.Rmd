...
```{r chart-gallery, fig.width=10, fig.height=6}
...
```{r visual-elements-demo, fig.width=8, fig.height=5}
library(ggplot2)
...
```{r scatter-step, fig.width=7, fig.height=4.8}
...
```{r scatter-lm, fig.width=7, fig.height=4.8}
...
```{r hist-density, fig.width=7, fig.height=4.8}
...
```{r boxplot-group, fig.width=7, fig.height=4.8}
...
```{r bar-summary, fig.width=7, fig.height=4.8}
library(dplyr)
...
```{r line-trend, fig.width=7, fig.height=4.8}
df_time <- data.frame(
  month = 1:12,
  value = c(78, 82, 80, 85, 88, 92, 95, 93, 90, 89, 87, 91)
)
...
```{r facet-demo, fig.width=8, fig.height=5}
...
```{r mini-case-visual, fig.width=7, fig.height=4.8}
ggplot(mtcars, aes(x = factor(cyl), y = mpg, fill = factor(cyl))) +
